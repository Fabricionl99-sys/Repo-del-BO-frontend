...
export const operators=[{id:'op_casino_astral',name:'Casino Astral',tier:'growth' as const,locale:'es-AR'},{id:'op_pampa_bet',name:'PampaBet',tier:'starter' as const,locale:'es-AR'}];
