...
export const xpRules: XPRule[] = [
  ...
  { id:'rule_slots_bet', name:'Apuesta en slots', description:'cuando bet_placed con categoría slots', status:'active', category:'slots', trigger:{event:'bet_placed',category:'slots'}, conditionsLogic:'all', conditions:[{field:'amount',operator:'gte',value:1}], action:{xpBase:10,xpPerAmount:{xp:10,amount:1,currency:'USD'},xpMaxPerEvent:1500}, applicableMultiplierIds:['mult_weekend'], createdAt:iso(112), updatedAt:iso(0.12), createdBy:{name:'Carlos Rodríguez',initials:'CR'} },
  { id:'rule_first_deposit_month', name:'Primer depósito del mes', description:'cuando deposit y is_first_of_month true', status:'active', category:'deposit', trigger:{event:'deposit',category:'deposit'}, conditionsLogic:'all', conditions:[{field:'is_first_of_month',operator:'eq',value:true}], action:{xpBase:500,alsoCoins:{amount:100,currencyId:'coin_oro'}}, applicableMultiplierIds:[], createdAt:iso(80), updatedAt:iso(1), createdBy:{name:'Fabricio Lasagna',initials:'FL'} },
  ...
  { id:'rule_feed_share', name:'Compartir post en feed', description:'cuando feed_post con shared true', status:'draft', category:'social', trigger:{event:'feed_post',category:'social'}, conditionsLogic:'all', conditions:[{field:'shared',operator:'eq',value:true}], action:{xpBase:5}, applicableMultiplierIds:[], createdAt:iso(1), updatedAt:new Date().toISOString(), createdBy:{name:'Pedro García',initials:'PG'} },
];
