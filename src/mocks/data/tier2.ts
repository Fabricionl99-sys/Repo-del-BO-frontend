...
export const xpRules: XPRule[] = [
  { id:'rule_sports_win', name:'Apuesta deportiva ganadora', description:'boost x2 hasta domingo 23:59', status:'active', category:'deportes', trigger:{event:'bet_placed',category:'deportes'}, conditionsLogic:'all', conditions:[{field:'result',operator:'eq',value:'win'},{field:'amount',operator:'gte',value:5}], action:{xpBase:50,xpPerAmount:{xp:50,amount:10,currency:'USD'},xpMaxPerEvent:2000}, boost:{enabled:true,multiplier:2,starts_at:iso(1),ends_at:iso(-5),scope:'category',category_code:'deportes'}, createdAt:iso(120), updatedAt:new Date(Date.now()-12*60000).toISOString(), createdBy:{name:'María López',initials:'ML'} },
  { id:'rule_slots_bet', name:'Apuesta en casino', description:'cuando bet_placed con categoría casino', status:'active', category:'casino', trigger:{event:'bet_placed',category:'casino'}, conditionsLogic:'all', conditions:[{field:'amount',operator:'gte',value:1}], action:{xpBase:10,xpPerAmount:{xp:10,amount:1,currency:'USD'},xpMaxPerEvent:1500}, boost:{enabled:true,multiplier:1.5,starts_at:iso(0.5),ends_at:iso(-2),scope:'all'}, createdAt:iso(112), updatedAt:iso(0.12), createdBy:{name:'Carlos Rodríguez',initials:'CR'} },
  { id:'rule_first_deposit_month', name:'Primer depósito del mes', description:'legacy audit · no acredita XP automático en MVP', status:'draft', category:'casino', trigger:{event:'bet_placed',category:'casino'}, conditionsLogic:'all', conditions:[{field:'is_first_of_month',operator:'eq',value:true}], action:{xpBase:500}, createdAt:iso(80), updatedAt:iso(1), createdBy:{name:'Fabricio Lasagna',initials:'FL'} },
  { id:'rule_poker_win', name:'Mano de poker ganada', description:'cuando bet_placed en poker', status:'active', category:'poker', trigger:{event:'bet_placed',category:'poker'}, conditionsLogic:'all', conditions:[{field:'result',operator:'eq',value:'win'}], action:{xpBase:25}, createdAt:iso(60), updatedAt:iso(2), createdBy:{name:'María López',initials:'ML'} },
  { id:'rule_champions_weekend', name:'Promo finde Champions League', description:'event_type champions y fin de semana', status:'paused', category:'deportes', trigger:{event:'bet_placed',category:'deportes'}, conditionsLogic:'all', conditions:[{field:'event_type',operator:'eq',value:'champions'},{field:'day_of_week',operator:'in',value:['sat','sun']}], action:{xpBase:100,xpPerAmount:{xp:100,amount:10,currency:'USD'}}, createdAt:iso(20), updatedAt:iso(5), createdBy:{name:'Carlos Rodríguez',initials:'CR'} },
  { id:'rule_live_table', name:'Mesa en vivo bonificada', description:'cuando bet_placed en casino en vivo', status:'active', category:'casino_vivo', trigger:{event:'bet_placed',category:'casino_vivo'}, conditionsLogic:'all', conditions:[{field:'table_type',operator:'eq',value:'roulette'}], action:{xpBase:35}, boost:{enabled:true,multiplier:3,starts_at:iso(0.2),ends_at:iso(-1),scope:'category',category_code:'casino_vivo'}, createdAt:iso(10), updatedAt:iso(1), createdBy:{name:'María López',initials:'ML'} },
  { id:'rule_virtual_match', name:'Partido virtual jugado', description:'cuando bet_placed en virtuales', status:'active', category:'virtuales', trigger:{event:'bet_placed',category:'virtuales'}, conditionsLogic:'all', conditions:[{field:'amount',operator:'gte',value:1}], action:{xpBase:15}, createdAt:iso(9), updatedAt:iso(1), createdBy:{name:'Carlos Rodríguez',initials:'CR'} }
];
