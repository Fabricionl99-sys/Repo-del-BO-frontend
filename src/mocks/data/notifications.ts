...
export const notificationTemplates: NotificationTemplate[] = [
  ...
  {
    id: 'ntpl_archived_legacy',
    code: 'legacy_promo',
    name: 'Promo legacy archivada',
    description: 'Template archivado de prueba',
    trigger_event: 'reward_pending',
    channels: ['in_app'],
    subject: null,
    body: 'Esta promo ya no está activa.',
    body_html: null,
    cta_text: null,
    cta_url: null,
    is_active: false,
