...
export const seedWheels: WheelType[] = [
  {
    ...
    center_logo_url: 'https://dummyimage.com/128x128/FFD700/1a1a1a&text=D',
    color_theme: '#FFD700',
    is_active: true,
    pity_enabled: false,
    pity_threshold: null,
  ...
  },
  {
    ...
    center_logo_url: 'https://dummyimage.com/128x128/7C3AED/ffffff&text=V',
    color_theme: '#7C3AED',
    is_active: true,
    pity_enabled: true,
    pity_threshold: 8,
  ...
  },
  {
    ...
    center_logo_url: 'https://dummyimage.com/128x128/DC2626/ffffff&text=W',
    color_theme: '#DC2626',
    is_active: true,
    pity_enabled: false,
    pity_threshold: null,
