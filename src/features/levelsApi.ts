...
import type { CurvePreset, CurvePreview, LevelsCurve, PlayerDistribution } from '@/types/levels';
...
export function usePreviewCurve(){return useMutation({mutationFn:(curve:LevelsCurve)=>apiClient.post('/admin/levels/curve/preview',curve).then(r=>r.data as CurvePreview)})}
