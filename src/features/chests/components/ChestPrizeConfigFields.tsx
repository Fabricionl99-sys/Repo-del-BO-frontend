import type { ChestPrizeFormValues } from '@/features/chests/chestPrizeForm';
import type { UseFormRegister } from 'react-hook-form';

export function ChestPrizeConfigFields({
  rewardType,
  register,
  chestTypeOptions,
}: {
  rewardType: ChestPrizeFormValues['reward_type'];
  register: UseFormRegister<ChestPrizeFormValues>;
