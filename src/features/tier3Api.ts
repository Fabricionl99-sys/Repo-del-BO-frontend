...
import type { Achievement, Chest, Mission, RewardsCycle, Tournament } from '@/types/tier3';
...
export const useAchievements=()=>useList<Achievement>('achievements','/admin/achievements'); export const useAchievement=(id:string|null)=>useItem<Achievement>('achievements','/admin/achievements',id); export const useSaveAchievement=()=>useSave<Achievement>('achievements','/admin/achievements','logro');
